...
@Component
public class ChunkMethodArgumentResolver extends AbstractMethodArgumentResolver {
	...
	@Override
	protected Object parse(Path path, long size, String contentRange, String contentLength) {
		long startOffset = 0;
		long endOffset = 0;
